...
@shared_task
def detect_model_image(instance: Model, image_field_name: str = processing_settings.IMAGE_FILED_NAME) -> None:
    ...
    try:
        ...
        if result:
            ...
            EmailWrapper(context=context, url_name=processing_settings.URL_NAME).send(to)
